...
@section('content')
    ...
    <div class="col-md-2">
        ...
        <input type="text" id="name" name="name" value="{{ request('name') }}" class="form-control" placeholder="Search by name">
    </div>

    <!-- Phone Number -->
    <div class="col-md-2">
        <label for="number" class="form-label">Phone Number</label>
        <input type="number" id="number" name="number" value="{{ request('number') }}" class="form-control" pattern="[0-9]*" inputmode="numeric" placeholder="Search by number">
    </div>
